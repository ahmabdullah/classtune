...
import com.classtune.classtuneapp.schoolapp.model.SchoolCandleSetting;
...
public class SchoolCandleSettingActivity extends ChildContainerActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.classtune.classtuneapp.R.layout.activity_school_candle_setting);
