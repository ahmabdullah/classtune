...
import com.classtune.classtuneapp.freeversion.SyllabusMidLayerActivity;
...
import com.classtune.classtuneapp.schoolapp.viewhelpers.CustomTabButtonEllipsizeText;
	...
	PickerItemSelectedListener PickerCallback = new PickerItemSelectedListener() {
		...
		public void onPickerItemSelected(BaseType item) {
			...
			case TEACHER_BATCH:
				...
				Intent i = new Intent("com.classtune.classtuneapp.schoolapp.batch");
